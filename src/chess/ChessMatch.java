...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		this.check = (testeCheck(opponent(currentPlayer))) ? true : false; // verifica se oponente está em xeque
	...
	// Verifica se há peça na posição desejada e se há algum movimento possível de
	// ser feito
	...
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) { // verifica se o movimento é possivel dependendo da peça de
															// origem
	...
	private void nextTurn() {
		this.turn++;
		this.currentPlayer = (this.currentPlayer == Color.WHITE) ? Color.BLACK : Color.WHITE; // if white current =
																								// black, else current =
																								// white
	}
	...
	// Testa se o rei dessa color está em xeque
